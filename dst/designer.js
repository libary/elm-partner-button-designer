							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Attributes$name('link'),
										_elm_lang$html$Html_Attributes$checked(
										_elm_lang$core$Native_Utils.eq(model.link, _user$project$Type$CreateAdvPage)),
										_elm_lang$html$Html_Events$onClick(
										_user$project$Type$ChangeLink(_user$project$Type$CreateAdvPage))
									]),
								_elm_lang$core$Native_List.fromArray(
									[])),
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$title('Подать объявление о продаже или сдаче в аренду недвижимости на 100 сайтов'),
