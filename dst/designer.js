...
var _user$project$Helpers$urlLink = function (model) {
	var refs = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: model.flags.refName, _1: model.flags.refValue}
		]);
	var _p0 = model.link;
	if (_p0.ctor === 'HomePage') {
		return A2(_evancz$elm_http$Http$url, model.flags.homePageUrl, refs);
	} else {
		return A2(_evancz$elm_http$Http$url, model.flags.createPageUrl, refs);
	}
};
...
var _user$project$Helpers$codeStr = function (model) {
	return _elm_lang$core$String$concat(
		_elm_lang$core$Native_List.fromArray(
			[
				'<a class=\"r100-button ',
				_user$project$Helpers$colorClass(model.color),
				'\" style=\"border-radius:',
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Ссылка на страницу')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										_elm_lang$html$Html_Attributes$name('link'),
								...
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html$text('главная страница')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html$text('страница подачи объявления')
							]))
					]))
			]));
};
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										_elm_lang$html$Html_Attributes$type$('radio'),
										_elm_lang$html$Html_Attributes$name('corner'),
										_elm_lang$html$Html_Attributes$checked(
								...
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html$text('острые')
							]))
					])),
				A2(
				_elm_lang$html$Html$div,
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[])),
								_elm_lang$html$Html$text('круглые')
							]))
					]))
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Размер')
					])),
				A2(
				_elm_lang$html$Html$input,
				_elm_lang$core$Native_List.fromArray(
							...
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										...
										{ctor: '_Tuple2', _0: 'r100-button-primary', _1: true},
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'r100-button', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-success', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
										{
										ctor: '_Tuple2',
										_0: 'r100-button-active',
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'r100-button', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-info', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
										{
										ctor: '_Tuple2',
										_0: 'r100-button-active',
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'r100-button', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-warning', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
										{
										ctor: '_Tuple2',
										_0: 'r100-button-active',
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'r100-button', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-danger', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
										{
										ctor: '_Tuple2',
										_0: 'r100-button-active',
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$core$Native_List.fromArray(
									[
										{ctor: '_Tuple2', _0: 'r100-button', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-default', _1: true},
										{ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
										{
										ctor: '_Tuple2',
										_0: 'r100-button-active',
			...
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						_elm_lang$html$Html_Attributes$placeholder('напишите текст для кнопки'),
						_elm_lang$html$Html_Events$onInput(_user$project$Type$ChangeText),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Код кнопки')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html$text('Так будет выглядеть кнопка')
					])),
				A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								_elm_lang$html$Html_Attributes$title(model.flags.title),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_user$project$View$preView(model),
						_user$project$View$codeView(model)
					]))
			]));
};
...
var _user$project$PartnerButtonDesigner$main = {
	...
	flags: A2(
		...
		A2(_elm_lang$core$Json_Decode_ops[':='], 'createPageUrl', _elm_lang$core$Json_Decode$string),
		function (createPageUrl) {
			return A2(
				_elm_lang$core$Json_Decode$andThen,
				A2(_elm_lang$core$Json_Decode_ops[':='], 'cssUrl', _elm_lang$core$Json_Decode$string),
				function (cssUrl) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'homePageUrl', _elm_lang$core$Json_Decode$string),
						function (homePageUrl) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
								A2(_elm_lang$core$Json_Decode_ops[':='], 'refName', _elm_lang$core$Json_Decode$string),
								function (refName) {
									return A2(
										_elm_lang$core$Json_Decode$andThen,
										A2(_elm_lang$core$Json_Decode_ops[':='], 'refValue', _elm_lang$core$Json_Decode$string),
										function (refValue) {
											return A2(
												_elm_lang$core$Json_Decode$andThen,
...
_elm_lang$core$Native_Platform.addPublicModule(Elm['PartnerButtonDesigner'], 'PartnerButtonDesigner', typeof _user$project$PartnerButtonDesigner$main === 'undefined' ? null : _user$project$PartnerButtonDesigner$main);
