...
var _user$project$Type$Model = F7(
	function (a, b, c, d, e, f, g) {
		return {text: a, color: b, size: c, font: d, corner: e, link: f, flags: g};
	});
var _user$project$Type$Flags = F6(
	function (a, b, c, d, e, f) {
		return {title: a, homePageUrl: b, createPageUrl: c, refName: d, refValue: e, cssUrl: f};
	});
...
var _user$project$Type$CreatePage = {ctor: 'CreatePage'};
var _user$project$Type$HomePage = {ctor: 'HomePage'};
...
var _user$project$Type$ChangeText = function (a) {
	return {ctor: 'ChangeText', _0: a};
};

var _user$project$Helpers$urlLink = function (model) {
	var baseUrl = function () {
		var _p0 = model.link;
		if (_p0.ctor === 'HomePage') {
			return model.flags.homePageUrl;
		} else {
			return model.flags.createPageUrl;
		}
	}();
	var ref = {
		ctor: '::',
		_0: {ctor: '_Tuple2', _0: model.flags.refName, _1: model.flags.refValue},
		_1: {ctor: '[]'}
	};
	return A2(_prikhi$elm_http_builder$HttpBuilder$url, baseUrl, ref);
};
var _user$project$Helpers$textSize = function (size) {
	return A2(_elm_lang$core$Basics_ops['++'], size, 'px');
};
var _user$project$Helpers$borderRadius = function (corner) {
	var _p1 = corner;
	if (_p1.ctor === 'Sharp') {
		return '0';
	} else {
...
var _user$project$Helpers$colorClass = function (color) {
	...
	switch (_p3.ctor) {
		...
		case 'Success':
			return 'r100-button-success';
		case 'Info':
			return 'r100-button-info';
		case 'Warning':
...
var _user$project$Helpers$codeStr = function (model) {
	return _elm_lang$core$String$concat(
		{
			ctor: '::',
			_0: '<a class=\"r100-button ',
			_1: {
				ctor: '::',
				_0: _user$project$Helpers$colorClass(model.color),
				_1: {
					ctor: '::',
					_0: '\" style=\"border-radius:',
					_1: {
						ctor: '::',
						_0: _user$project$Helpers$borderRadius(model.corner),
						_1: {
							ctor: '::',
							_0: ';font-size:',
							_1: {
								ctor: '::',
								_0: _user$project$Helpers$textSize(model.size),
								_1: {
									ctor: '::',
									_0: ';font-weight:',
									_1: {
										ctor: '::',
										_0: _user$project$Helpers$fontWeight(model.font),
										_1: {
											ctor: '::',
											_0: ';\" href=\"',
											_1: {
												ctor: '::',
												_0: _user$project$Helpers$urlLink(model),
												_1: {
													ctor: '::',
													_0: '\" title=\"',
													_1: {
														ctor: '::',
														_0: model.flags.title,
														_1: {
															ctor: '::',
															_0: '\">',
															_1: {
																...
																_1: {
																	ctor: '::',
																	_0: '</a><link rel=\"stylesheet\" type=\"text/css\" href=\"',
																	_1: {
																		ctor: '::',
																		_0: model.flags.cssUrl,
																		_1: {
																			ctor: '::',
																			_0: '\" />',
																			_1: {ctor: '[]'}
...
var _user$project$View$linkView = function (model) {
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Ссылка на страницу'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$name('link'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$checked(
													_elm_lang$core$Native_Utils.eq(model.link, _user$project$Type$HomePage)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Type$ChangeLink(_user$project$Type$HomePage)),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('главная страница'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
						...
						},
						{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
										...
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$checked(
														_elm_lang$core$Native_Utils.eq(model.link, _user$project$Type$CreatePage)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Type$ChangeLink(_user$project$Type$CreatePage)),
														_1: {ctor: '[]'}
													}
												}
											}
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('страница подачи объявления'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
...
var _user$project$View$cornerView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Углы'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$name('corner'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$checked(
													_elm_lang$core$Native_Utils.eq(model.corner, _user$project$Type$Sharp)),
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Events$onClick(
														_user$project$Type$ChangeCorner(_user$project$Type$Sharp)),
													_1: {ctor: '[]'}
												}
											}
										}
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('острые'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
						...
						},
						{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
										...
										_elm_lang$html$Html$input,
										{
											...
											_1: {
												...
												_1: {
													ctor: '::',
													_0: _elm_lang$html$Html_Attributes$checked(
														_elm_lang$core$Native_Utils.eq(model.corner, _user$project$Type$Round)),
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Type$ChangeCorner(_user$project$Type$Round)),
														_1: {ctor: '[]'}
													}
												}
											}
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('круглые'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Шрифт'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
							...
							{ctor: '[]'},
							{
								...
								_0: A2(
									_elm_lang$html$Html$input,
									{
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$name('font'),
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Attributes$checked(
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html$text('нормальный'),
									_1: {ctor: '[]'}
								}
							}),
						_1: {ctor: '[]'}
						...
						},
						{
							...
							_0: A2(
								...
								{ctor: '[]'},
								{
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html$text('жирный'),
										_1: {ctor: '[]'}
									}
								}),
							_1: {ctor: '[]'}
	...
	return A2(
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Размер'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
					...
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								...
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Type$ChangeSize),
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Attributes$value(model.size),
										_1: {ctor: '[]'}
									}
								}
							}
...
var _user$project$View$colorView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Цвет'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$button,
							{
								...
								_0: _elm_lang$html$Html_Attributes$classList(
									{
										ctor: '::',
										_0: {ctor: '_Tuple2', _0: 'r100-button', _1: true},
										_1: {
											ctor: '::',
											_0: {ctor: '_Tuple2', _0: 'r100-button-primary', _1: true},
											_1: {
												ctor: '::',
												_0: {ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
												_1: {
													ctor: '::',
													_0: {
														ctor: '_Tuple2',
														_0: 'r100-button-active',
														_1: _elm_lang$core$Native_Utils.eq(model.color, _user$project$Type$Primary)
													},
													_1: {ctor: '[]'}
												}
											}
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: _elm_lang$html$Html_Events$onClick(
											_user$project$Type$ChangeColor(_user$project$Type$Primary)),
										_1: {ctor: '[]'}
									}
								}
							},
									...
									_elm_lang$html$Html$button,
									{
										...
										_0: _elm_lang$html$Html_Attributes$classList(
											{
												...
												_1: {
													ctor: '::',
													_0: {ctor: '_Tuple2', _0: 'r100-button-success', _1: true},
													_1: {
														ctor: '::',
														_0: {ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
														_1: {
															...
															_0: {
																ctor: '_Tuple2',
																_0: 'r100-button-active',
																_1: _elm_lang$core$Native_Utils.eq(model.color, _user$project$Type$Success)
															},
															_1: {ctor: '[]'}
														}
													}
										...
										_1: {
											...
											_1: {
												ctor: '::',
												_0: _elm_lang$html$Html_Events$onClick(
													_user$project$Type$ChangeColor(_user$project$Type$Success)),
												_1: {ctor: '[]'}
											}
										}
									},
											...
											_elm_lang$html$Html$button,
											{
												...
												_0: _elm_lang$html$Html_Attributes$classList(
													{
														...
														_1: {
															ctor: '::',
															_0: {ctor: '_Tuple2', _0: 'r100-button-info', _1: true},
															_1: {
																ctor: '::',
																_0: {ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
																_1: {
																	...
																	_0: {
																		ctor: '_Tuple2',
																		_0: 'r100-button-active',
																		_1: _elm_lang$core$Native_Utils.eq(model.color, _user$project$Type$Info)
																	},
																	_1: {ctor: '[]'}
																}
															}
												...
												_1: {
													...
													_1: {
														ctor: '::',
														_0: _elm_lang$html$Html_Events$onClick(
															_user$project$Type$ChangeColor(_user$project$Type$Info)),
														_1: {ctor: '[]'}
													}
												}
											},
													...
													_elm_lang$html$Html$button,
													{
														...
														_0: _elm_lang$html$Html_Attributes$classList(
															{
																...
																_1: {
																	ctor: '::',
																	_0: {ctor: '_Tuple2', _0: 'r100-button-warning', _1: true},
																	_1: {
																		ctor: '::',
																		_0: {ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
																		_1: {
																			...
																			_0: {
																				ctor: '_Tuple2',
																				_0: 'r100-button-active',
																				_1: _elm_lang$core$Native_Utils.eq(model.color, _user$project$Type$Warning)
																			},
																			_1: {ctor: '[]'}
																		}
																	}
														...
														_1: {
															...
															_1: {
																ctor: '::',
																_0: _elm_lang$html$Html_Events$onClick(
																	_user$project$Type$ChangeColor(_user$project$Type$Warning)),
																_1: {ctor: '[]'}
															}
														}
													},
															...
															_elm_lang$html$Html$button,
															{
																...
																_0: _elm_lang$html$Html_Attributes$classList(
																	{
																		...
																		_1: {
																			ctor: '::',
																			_0: {ctor: '_Tuple2', _0: 'r100-button-danger', _1: true},
																			_1: {
																				ctor: '::',
																				_0: {ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
																				_1: {
																					...
																					_0: {
																						ctor: '_Tuple2',
																						_0: 'r100-button-active',
																						_1: _elm_lang$core$Native_Utils.eq(model.color, _user$project$Type$Danger)
																					},
																					_1: {ctor: '[]'}
																				}
																			}
																...
																_1: {
																	...
																	_1: {
																		ctor: '::',
																		_0: _elm_lang$html$Html_Events$onClick(
																			_user$project$Type$ChangeColor(_user$project$Type$Danger)),
																		_1: {ctor: '[]'}
																	}
																}
															},
																		...
																		_0: _elm_lang$html$Html_Attributes$classList(
																			{
																				...
																				_1: {
																					ctor: '::',
																					_0: {ctor: '_Tuple2', _0: 'r100-button-default', _1: true},
																					_1: {
																						ctor: '::',
																						_0: {ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
																						_1: {
																							...
																							_0: {
																								ctor: '_Tuple2',
																								_0: 'r100-button-active',
																								_1: _elm_lang$core$Native_Utils.eq(model.color, _user$project$Type$Default)
																							},
																							_1: {ctor: '[]'}
																						}
																					}
																				...
																				_0: _elm_lang$html$Html_Attributes$classList(
																					{
																						...
																						_1: {
																							ctor: '::',
																							_0: {ctor: '_Tuple2', _0: 'r100-button-white', _1: true},
																							_1: {
																								ctor: '::',
																								_0: {ctor: '_Tuple2', _0: 'r100-button-ss', _1: true},
																								_1: {
...
var _user$project$View$titleView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Текст'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					_elm_lang$html$Html$input,
					{
						...
						_1: {
							...
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$placeholder('напишите текст для кнопки'),
								_1: {
									ctor: '::',
									_0: _elm_lang$html$Html_Events$onInput(_user$project$Type$ChangeText),
									_1: {
										ctor: '::',
...
var _user$project$View$codeView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Код кнопки'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
						...
						_0: A2(
							_elm_lang$html$Html$textarea,
							{
								...
								_1: {
									...
									_1: {
										ctor: '::',
										_0: A2(_elm_lang$html$Html_Attributes$attribute, 'onclick', 'this.select();'),
										_1: {ctor: '[]'}
									}
								}
							},
							{
								ctor: '::',
								_0: _elm_lang$html$Html$text(
									_user$project$Helpers$codeStr(model)),
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}),
...
var _user$project$View$preView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{
			ctor: '::',
		...
		},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Так будет выглядеть кнопка'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
							...
							_elm_lang$html$Html$a,
							{
								...
								_1: {
									...
									_0: _elm_lang$html$Html_Attributes$style(
										{
											...
											_0: {
												ctor: '_Tuple2',
												_0: 'border-radius',
												_1: _user$project$Helpers$borderRadius(model.corner)
											},
											_1: {
												ctor: '::',
												_0: {
									...
									_1: {
										...
										_1: {
											ctor: '::',
											_0: _elm_lang$html$Html_Attributes$title(model.flags.title),
											_1: {
												ctor: '::',
		...
		},
		{
			...
			_0: A2(
				_elm_lang$html$Html$div,
				{
					...
					_1: {
						...
						_0: _elm_lang$html$Html_Attributes$style(
							{
								ctor: '::',
								_0: {ctor: '_Tuple2', _0: 'border-right', _1: '1px solid lightgrey'},
								_1: {ctor: '[]'}
							}),
						_1: {ctor: '[]'}
					}
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _user$project$View$titleView(model),
							_1: {
								ctor: '::',
								_0: _user$project$View$colorView(model),
								_1: {
									ctor: '::',
									_0: _user$project$View$sizeView(model),
									_1: {
										ctor: '::',
										_0: _user$project$View$fontView(model),
										_1: {
											ctor: '::',
											_0: _user$project$View$cornerView(model),
											_1: {
												ctor: '::',
												_0: _user$project$View$linkView(model),
												_1: {ctor: '[]'}
											}
										}
									}
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _user$project$View$preView(model),
						_1: {
							ctor: '::',
							_0: _user$project$View$codeView(model),
							_1: {ctor: '[]'}
						}
					}),
				_1: {ctor: '[]'}
...
var _user$project$PartnerButtonDesigner$update = F2(
	function (msg, model) {
		var _p0 = msg;
		switch (_p0.ctor) {
			case 'ChangeText':
...
var _user$project$PartnerButtonDesigner$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$PartnerButtonDesigner$init = function (flags) {
	return {
		...
		_0: {
			...
			color: _user$project$Type$Primary,
			size: '15',
			font: _user$project$Type$Normal,
			corner: _user$project$Type$Sharp,
			link: _user$project$Type$HomePage,
			flags: {title: flags.title, homePageUrl: flags.homePageUrl, createPageUrl: flags.createPageUrl, refName: flags.refName, refValue: flags.refValue, cssUrl: flags.cssUrl}
		},
		_1: _elm_lang$core$Platform_Cmd$none
	};
};
var _user$project$PartnerButtonDesigner$main = _elm_lang$html$Html$programWithFlags(
	{init: _user$project$PartnerButtonDesigner$init, update: _user$project$PartnerButtonDesigner$update, subscriptions: _user$project$PartnerButtonDesigner$subscriptions, view: _user$project$View$view})(
	A2(
		_elm_lang$core$Json_Decode$andThen,
											...
											return A2(
												...
												function (title) {
													return _elm_lang$core$Json_Decode$succeed(
														{createPageUrl: createPageUrl, cssUrl: cssUrl, homePageUrl: homePageUrl, refName: refName, refValue: refValue, title: title});
												},
												A2(_elm_lang$core$Json_Decode$field, 'title', _elm_lang$core$Json_Decode$string));
										},
										A2(_elm_lang$core$Json_Decode$field, 'refValue', _elm_lang$core$Json_Decode$string));
								},
								A2(_elm_lang$core$Json_Decode$field, 'refName', _elm_lang$core$Json_Decode$string));
						},
						A2(_elm_lang$core$Json_Decode$field, 'homePageUrl', _elm_lang$core$Json_Decode$string));
				},
				A2(_elm_lang$core$Json_Decode$field, 'cssUrl', _elm_lang$core$Json_Decode$string));
		},
		A2(_elm_lang$core$Json_Decode$field, 'createPageUrl', _elm_lang$core$Json_Decode$string)));

var Elm = {};
Elm['PartnerButtonDesigner'] = Elm['PartnerButtonDesigner'] || {};
if (typeof _user$project$PartnerButtonDesigner$main !== 'undefined') {
    _user$project$PartnerButtonDesigner$main(Elm['PartnerButtonDesigner'], 'PartnerButtonDesigner', undefined);
}
